...
echo "$JAVA_HOME/bin/java --module-path mlib\;ifamlib\;amlib --add-modules slf4j.simple -m modmain/pkgmain.Main | myecho"
$JAVA_HOME/bin/java --module-path mlib\;ifamlib\;amlib --add-modules slf4j.simple -m modmain/pkgmain.Main | myecho
...
# 
# $JAVA_HOME/bin/java --module-path mlib\;ifamlib\;amlib --add-modules slf4j.jdk14 -m modmain/pkgmain.Main | myecho
$JAVA_HOME/bin/java --module-path mlib\;ifamlib\;amlib --add-modules slf4j.jdk -m modmain/pkgmain.Main | myecho
