...
$JAVA_HOME/bin/java $JAVA_OPTIONS --patch-module modb=patches/modb --module-path mlib --module modmain/pkgmain.Main | myecho

# Patch modb with a modular jar
echo ">> Start modmain/pkgmain.Main with patch classes from patchlib/modb.jar"
$JAVA_HOME/bin/java $JAVA_OPTIONS --patch-module modb=patchlib/modb.jar --module-path mlib --module modmain/pkgmain.Main | myecho
