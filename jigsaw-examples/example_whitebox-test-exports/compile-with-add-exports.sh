...
echo "javac -Xlint --add-exports modfib/pkgfib.internal=modtest.whitebox -d mods --module-path amlib${PATH_SEPARATOR}mlib --module-source-path src \$(find src -name \"*.java\")"
