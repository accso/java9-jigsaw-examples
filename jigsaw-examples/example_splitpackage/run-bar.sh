...
$JAVA_HOME/bin/java $JAVA_OPTIONS --module-path mlib                       -m modmainbar/pkgmainbar.Main | myecho
...
$JAVA_HOME/bin/java $JAVA_OPTIONS --module-path mlib --add-modules modsplitbar2 -m modmainbar/pkgmainbar.Main | myecho
