...
$JAVA_HOME/bin/java $JAVA_OPTIONS --module-path mlib                       --module modmainbar/pkgmainbar.Main | myecho
...
$JAVA_HOME/bin/java $JAVA_OPTIONS --module-path mlib --add-modules modsplitbar2 --module modmainbar/pkgmainbar.Main | myecho
