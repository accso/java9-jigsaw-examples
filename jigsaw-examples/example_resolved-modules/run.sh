...
$JAVA_HOME/bin/java --module-path mlib --module moda/pkga.AMain | myecho
...
$JAVA_HOME/bin/java --module-path mlib --module modb/pkgb.BMain | myecho
...
$JAVA_HOME/bin/java --module-path mlib --module modc/pkgc.CMain | myecho
...
$JAVA_HOME/bin/java --module-path mlib --add-modules modc --module modb/pkgb.BMain | myecho
...
$JAVA_HOME/bin/java --module-path mlib${PATH_SEPARATOR}amlib --module modb/pkgb.BMain | myecho
...
$JAVA_HOME/bin/java --module-path mlib --limit-modules modb --module modb/pkgb.BMain | myecho
...
$JAVA_HOME/bin/java --module-path mlib --limit-modules java.logging,java.scripting,modb --module modb/pkgb.BMain | myecho
