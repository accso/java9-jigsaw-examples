...
* modmain, commons.lang3 (automatic)
...
The maven compile and surefire plugins recognize the test classes as own modules here, because there is a `module-info.java`
